...
<table width="700" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr> 
    <td height="26" colspan="2"> <? include("menu.inc.php");?>      
    </td>
  </tr>
  <tr> 
...
<table width="700" border="0" cellspacing="0" cellpadding="0" >
  <tr> 
    <td> <?if ($action=="delete") {
					include("apply_fee_dlr_delete.inc.php");
				} else if ($action=="write") {
					include("apply_fee_dlr_write.inc.php");
				} else if ($action=="modify") {
					include("apply_fee_dlr_modify.inc.php");
				} else if ($action=="add") {
				    include("apply_fee_dlr_add.inc.php");
				} else if ($action=="new") {
				    include("apply_fee_dlr_new.inc.php");
				} else {
				    include("apply_fee_dlr_list.inc.php");
				}?> </td>
  </tr>
</table>
