...
$query = mysql_query ("select * from pro_cable_item") ;
...
$query=mysql_query("select * from pro_cable_item order by nu limit ".$limitnum.",".$splitnum);
...
<table width=80%  cellspacing=1 bgcolor= "31415A" style="margin-top: 8">
<tr align="center" bgcolor="C6C7E7" height="22">
	...
	<td width="40%" background="images/back_99.gif">種 類(中)</td>
	<td width="40%" background="images/back_99.gif">種 類(英)</td>
	<td width="20" background="images/back_99.gif">隱藏碼</td>
</tr>
...
for ($i=0;$i<count($rowdata);$i++) {
	...
	<tr bgcolor="<? echo (($i+1)%2==0) ? "EFEFEF":"FFFFFF" ?>" align="center" height=22>
		...
		<td><input type="checkbox" name="nu" value="<? echo $rowdata[$i][nu] ?>"></td>
		<td align="left">&nbsp;<? echo $rowdata[$i][item]?></td>
		<td align="left">&nbsp;<? echo $rowdata[$i][item_eng]?></td>
		<td align="left">&nbsp;<? echo $rowdata[$i][nu]?></td>
	</tr>
