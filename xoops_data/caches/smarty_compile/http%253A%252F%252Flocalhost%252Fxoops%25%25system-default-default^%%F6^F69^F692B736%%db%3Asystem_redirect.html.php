<?php /* Smarty version 2.6.26, created on 2010-06-17 16:59:36
...
<div id="xo-wrapper" class="container center">
    <div id="xo-redirect">
        <div class="message">
            ...
            <br />
            <img src="<?php 
echo 'http://localhost/xoops/themes/default/icons/ajax_indicator_01.gif'; ?>" alt="<?php echo $this->_tpl_vars['message']; ?>
"/>
        </div>
        <div class="notreload">
