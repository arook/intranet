...
define('_BANNERS_MANAGEMENT', 'Advertising Managment');
define('_BANNERS_WELCOMEBACK', 'Welcome: %s');
define('_BANNERS_LOGGEDOUT', 'Logged out the advertisement panel');
define('_BANNERS_LOGOUT', 'Log Out Advertising Manager');
...
define('_BANNERS_NOTHINGFOUND', 'No Records Found');
define('_BANNERS_NO', '#');
...
define('_BANNERS_MAIL_MESSAGE', 'Available Advertising Statistics for the selected Banner at %s :\n\n\n
Client Name: %s\nBanner ID: %s\n
Banner Image: %s\n
Banner URL: %s\n\n
...
define('_BANNERS_MAIL_OK', 'Available advertising statistics for the selected banner have been sent to your account email address.');
