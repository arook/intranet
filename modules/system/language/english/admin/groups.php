...
* New in 2.4.0
*/
define('_AM_LIST_GROUPS', 'List Groups');
define('_XO_AD_GROUP_ID', '#');
define('_XO_AD_GROUP_NAME', 'Group Name');
define('_XO_AD_GROUP_DESCRIPTION', 'Group Description');
define('_XO_AD_GROUP_ACTION', 'Action');
