...
$query = mysql_query ("select * from exhibition") ;
...
$query=mysql_query("select * from exhibition order by sn desc limit ".$limitnum.",".$splitnum);
...
<tr align="center" bgcolor="C6C7E7" height="22">
	...
	<td background="images/back_99.gif">展 覽 主 題</td>
</tr>
