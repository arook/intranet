...
$query = mysql_query ("select * from expense_fee_type") ;
...
$query=mysql_query("select * from expense_fee_type order by fee_sta desc , fee_ord limit ".$limitnum.",".$splitnum);
...
<tr>
  ...
  <table width=100%  cellspacing=1 style="margin-top: 8">
    <tr align="center" height="22"> 
	  ...
	  <td align="center" bgcolor="CCCCCC">選</td>
	  <td align="center" bgcolor="CCCCCC">顯/隱</td>
	  <td align="center" bgcolor="CCCCCC">排序</td>
	  <td align="center" width=200 bgcolor="CCCCCC">名稱(中)</td>
	  <td align="center" width=100 bgcolor="CCCCCC">編碼</td>
	  <td align="center" width=100 bgcolor="CCCCCC">金額上限</td>
</tr>
...
<?for ($i=0;$i<count($rowdata);$i++) {?>
	...
	<tr align="center" height=22> 
      ...
      <td align="left"><? echo $rowdata[$i][fee_sta] ? '顯示' : '隱藏';?></td>

	  <td align="left">&nbsp;<? echo $rowdata[$i][fee_ord] ?></td>

	  <td align="left">&nbsp;<? echo $rowdata[$i][fee_name] ?></td>
		
		
      <td>&nbsp;<? echo $rowdata[$i][fee_nu] ?></td>
	  <td align="right">&nbsp;<? echo $rowdata[$i][m_target]?></td>
	</tr>
	<tr> 
      <td height=1 bgcolor="#666666" colspan="7"></td>
    </tr>
	<?}?>
</table>
