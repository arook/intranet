<?php
// $Id: main.php 2705 2009-01-21 09:19:31Z phppp $
//  ------------------------------------------------------------------------ //
...
if ( $op == "form" ) {
    ...
    echo "<h4>"._AM_FINDUS."</h4>(".sprintf(_AM_ACTUS, "<span style='color:#ff0000;'>$acttotal</span>")." ".sprintf(_AM_INACTUS, "<span style='color:#ff0000;'>$inacttotal</span>").")";
    $form->display();
}
