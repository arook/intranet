<?php /* Smarty version 2.6.26, created on 2010-06-17 17:10:08
         compiled from /Users/kky979899/Documents/workspace_c/xoops/themes/default/theme.html */ ?>
...
echo 'http://localhost/xoops/themes/default/icons/favicon.ico'; ?>" />
    <link rel="icon" type="image/png" href="<?php 
echo 'http://localhost/xoops/themes/default/icons/favicon.png'; ?>" />

    <!-- Sheet Css -->
    <link rel="stylesheet" type="text/css" media="all" title="Style sheet" href="<?php echo 'http://localhost/xoops/xoops.css'; ?>" />
    <link rel="stylesheet" type="text/css" media="all" title="Style sheet" href="<?php 
echo 'http://localhost/xoops/themes/default/style.css'; ?>" />
...
<table cellspacing="0">
    <tr id="header">
        <td id="headerlogo"><a href="<?php echo 'http://localhost/xoops/'; ?>" title="<?php echo $this->_tpl_vars['xoops_sitename']; ?>
"><img src="<?php 
echo 'http://localhost/xoops/themes/default/xoops-logo.png'; ?>" alt="<?php echo $this->_tpl_vars['xoops_sitename']; ?>
" /></a></td>
