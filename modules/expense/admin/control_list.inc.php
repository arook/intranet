<?
$query = mysql_query ("select * from pro_admin") ;
...
<tr>
	<td>
		<input type="button" value="新增帳號" onClick="CheckAction('new')">
		<? if ($rowsize>0) { ?>
		<input type="button" value="修改帳號" onClick="CheckAction('modify')">　
		<input type="button" value="刪除帳號" onClick="CheckAction('delete')">
		<? } else { ?>
		<input type="button" value="修改帳號" style="color: 8C8C8C">　
		<input type="button" value="刪除帳號" style="color: 8C8C8C">
		<? } ?>
...
<tr align="center" bgcolor="C6C7E7" height="22">
	...
	<td width=100 background="images/back_99.gif">帳　號</td>
