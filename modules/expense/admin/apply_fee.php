...
<table width="700" border="0" cellspacing="0" cellpadding="0" >
  <tr> 
    <td> <?if ($action=="delete") {
					include("apply_fee_delete.inc.php");
				} else if ($action=="write") {
					include("apply_fee_write.inc.php");
				} else if ($action=="modify") {
					include("apply_fee_modify.inc.php");
				} else if ($action=="add") {
				    include("apply_fee_add.inc.php");
				} else if ($action=="new") {
				    include("apply_fee_new.inc.php");
				} else {
