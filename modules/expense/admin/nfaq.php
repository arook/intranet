	...
	<td>
		...
		<tr>
			<td>
				...
				if ($action=="delete") {
					include("nfaq_delete.inc.php");
				} else if ($action=="write") {
					include("nfaq_write.inc.php");
				} else if ($action=="modify") {
					include("nfaq_modify.inc.php");
				} else if ($action=="add") {
				    include("nfaq_add.inc.php");
				} else if ($action=="new") {
				    include("nfaq_new.inc.php");
				} else {
				    include("nfaq_list.inc.php");
				}
