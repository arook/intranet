	...
	<td>
		...
		<tr>
			<td>
				...
				if ($action=="delete") {
					include("download_delete.inc.php");
				} else if ($action=="write") {
					include("download_write.inc.php");
				} else if ($action=="modify") {
					include("download_modify.inc.php");
				} else if ($action=="add") {
				    include("download_add.inc.php");
				} else if ($action=="new") {
				    include("download_new.inc.php");
				} else {
				    include("download_list.inc.php");
				}
