...
<table width="700" border="0" cellspacing="0" cellpadding="0" >
  <tr> 
    <td> <?
				...
				if ($action=="delete") {
					include("apply_fee_item_delete.inc.php");
				} else if ($action=="write") {
					include("apply_fee_item_write.inc.php");
				} else if ($action=="modify") {
					include("apply_fee_item_modify.inc.php");
				} else if ($action=="add") {
				    include("apply_fee_item_add.inc.php");
				} else if ($action=="new") {
				    include("apply_fee_item_new.inc.php");
				} else {
				    include("apply_fee_item_list.inc.php");
				}
