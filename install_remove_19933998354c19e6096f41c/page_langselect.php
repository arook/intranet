 ...
 * @version     $Id: page_langselect.php 3562 2009-09-03 14:55:02Z trabis $
**/

require_once './include/common.inc.php';
defined('XOOPS_INSTALL') or die('XOOPS Installation wizard die');

setcookie('xo_install_lang', 'tchinese_utf8', null, null, null);
...
$langtxt=array("english"=>"English","tchinese"=>"正體中文Big5版","tchinese_utf8"=>"正體中文UTF8版");
foreach ($languages as $lang) {
    $sel = ($lang == $wizard->language) ? ' selected="selected"' : '';
    $content .= "<option value=\"{$lang}\"{$sel}>{$langtxt[$lang]}</option>\n";
}
$content .= "</select>";
